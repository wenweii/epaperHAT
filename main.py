...
try:
    ...
    drawblack.text((150, 0), u'微雪電子', font = font24, fill = 0)
    ...
    LBlackimage = Image.new('1', (epd2in7b.EPD_WIDTH, epd2in7b.EPD_HEIGHT), 255)  # 126*298
    LRedimage = Image.new('1', (epd2in7b.EPD_WIDTH, epd2in7b.EPD_HEIGHT), 255)  # 126*298
    # Vertical
    ...
    drawblack.text((20, 50), u'微雪電子', font = font18, fill = 0)
